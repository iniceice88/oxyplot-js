import { Axis, type CreateAxisAxisOptions, FractionHelper } from '@/oxyplot'
import { removeUndef } from '@/patch'

export interface CreateLinearAxisOptions extends CreateAxisAxisOptions {
  fractionUnit?: number
...
export class LinearAxis extends Axis {
  ...
  public constructor(opt?: CreateLinearAxisOptions) {
    ...
    this.fractionUnitSymbol = undefined
