 ...
 */
export class OxyMouseWheelGesture implements OxyInputGesture {
  /**
   * Initializes a new instance of the `OxyMouseWheelGesture` class.
  ...
  public equals(other: OxyInputGesture): boolean {
    if (!(other instanceof OxyMouseWheelGesture)) return false

    const mwg = other as OxyMouseWheelGesture
    return mwg.modifiers === this.modifiers
  }
}
